...
$arSettings = array(
	...
	"LAST_RUN_FILE_NAME" => "opentao_cron_last_run.txt", // last time all import operations were finished
	"LAST_PROFILE_FILE_NAME" => "opentao_cron_last_profile.txt", // stores last ID of proceeded import profile
	"OFFSET_FILE_NAME" => "opentao_cron_offset.txt", // stores the number of proceeded elements
