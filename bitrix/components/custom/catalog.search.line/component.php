...
/*
THIS COMPONENT DIFFERS FROM catalog.section.list only in filter settings - sections received must have option UF_SHOW_IN_SEARCH set
*/
	...
	)
	{
		...
		if(isset($arResult["SECTION"]) && $arResult["SECTION"]['IBLOCK_SECTION_ID'] > 0)
		{
			$rsSection = CIBlockSection::GetList(
				array(),
				array_merge($arFilter,array("=ID" => $arResult["SECTION"]['IBLOCK_SECTION_ID'])),
				false,
