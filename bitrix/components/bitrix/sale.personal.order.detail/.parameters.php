...
if(CModule::IncludeModule("iblock"))
{
	...
	$arComponentParameters["PARAMETERS"]["PREVIEW_PICTURE_WIDTH"] = array(
	...
	$arComponentParameters["PARAMETERS"]["PREVIEW_PICTURE_HEIGHT"] = array(
	...
	$arComponentParameters["PARAMETERS"]["DETAIL_PICTURE_WIDTH"] = array(
		"NAME" => GetMessage("SPOD_PARAM_DETAIL_PICTURE_WIDTH"),
		"TYPE" => "STRING",
		"MULTIPLE" => "N",
		"DEFAULT" => "110",
		"PARENT" => "VISUAL",
	);
	$arComponentParameters["PARAMETERS"]["DETAIL_PICTURE_HEIGHT"] = array(
		"NAME" => GetMessage("SPOD_PARAM_DETAIL_PICTURE_HEIGHT"),
		"TYPE" => "STRING",
		"MULTIPLE" => "N",
		"DEFAULT" => "110",
		"PARENT" => "VISUAL",
	);
	$arComponentParameters["PARAMETERS"]["RESAMPLE_TYPE"] = array(
