...
<noindex>
    <div class="show-for-large-up">
        <div class="side_menu">
            <? foreach ($arResult["SECTIONS"] as $arSection): ?>
                ...
                ?>
                <a href="<?= $arSection["SECTION_PAGE_URL"] ?>"<? if ($arSection["ID"] == $arParams['_CURRENT']): ?> class="current"<? endif; ?>
    ...
    <div class="hide-for-large-up">
        <select class="custom" id="side_menu">
            ...
            <? foreach ($arResult["SECTIONS"] as $arSection): ?>
                <option
                    value="<?= $arSection["SECTION_PAGE_URL"] ?>"<? if ($arSection["ID"] == $arParams['_CURRENT']): ?> selected<? endif; ?>><?= $arSection["NAME"] ?></option>
            <? endforeach; ?>
        </select>
    </div>
</noindex>